...
if (!function_exists('on_subscription_box_get')) 
{
	function on_subscription_box_get($attrs) 
	{
		...
		//			default: ""
		// success: a success message to display on success
		// error: an error message to display on error
		...
		$success = on_get_val('success', $attrs, "Thanks for subscribing!");
		$error = on_get_val('error', $attrs, "Please try again");
